...
```javascript
doWhileEach = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-do-while-each@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-do-while-each@umd/bundle.js"></script>
```
